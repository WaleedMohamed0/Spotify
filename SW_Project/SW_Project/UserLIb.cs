...
namespace SW_Project {
    ...
    public class UserLIb : ReportClass {
    ...
    public class CachedUserLIb : Component, ICachedReport {
        
        public CachedUserLIb() {
        }
